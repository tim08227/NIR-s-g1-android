...
public class AddScanConfigViewActivity extends Activity {
    ...
    ArrayList<TextView>tv_oversample = new ArrayList<>();
    TextView tv_oversample1;
    TextView tv_oversample2;
    TextView tv_oversample3;
    TextView tv_oversample4;
    TextView tv_oversample5;

    ArrayList<ImageButton>img_tooltip = new ArrayList<>();
    ImageButton img_tooltip1;
    ImageButton img_tooltip2;
    ImageButton img_tooltip3;
    ImageButton img_tooltip4;
    ImageButton img_tooltip5;
    ...
    private void init_text_width_plus() {
        text_width.add("Width(2-61):2nm");
        text_width.add("Width(2-61):3nm");
        text_width.add("Width(2-61):4nm");
        text_width.add("Width(2-61):5nm");
        text_width.add("Width(2-61):6nm");
        text_width.add("Width(2-61):7nm");
        text_width.add("Width(2-61):8nm");
        text_width.add("Width(2-61):9nm");
        text_width.add("Width(2-61):10nm");
        text_width.add("Width(2-61):11nm");
        text_width.add("Width(2-61):12nm");
        text_width.add("Width(2-61):13nm");
        text_width.add("Width(2-61):14nm");
        text_width.add("Width(2-61):15nm");
        text_width.add("Width(2-61):16nm");
        text_width.add("Width(2-61):17nm");
        text_width.add("Width(2-61):18nm");
        text_width.add("Width(2-61):19nm");
        text_width.add("Width(2-61):20nm");
        text_width.add("Width(2-61):21nm");
        text_width.add("Width(2-61):22nm");
        text_width.add("Width(2-61):23nm");
        text_width.add("Width(2-61):24nm");
        text_width.add("Width(2-61):25nm");
        text_width.add("Width(2-61):26nm");
        text_width.add("Width(2-61):27nm");
        text_width.add("Width(2-61):28nm");
        text_width.add("Width(2-61):29nm");
        text_width.add("Width(2-61):30nm");
        text_width.add("Width(2-61):31nm");
        text_width.add("Width(2-61):32nm");
        text_width.add("Width(2-61):33nm");
        text_width.add("Width(2-61):34nm");
        text_width.add("Width(2-61):35nm");
        text_width.add("Width(2-61):36nm");
        text_width.add("Width(2-61):37nm");
        text_width.add("Width(2-61):38nm");
        text_width.add("Width(2-61):39nm");
        text_width.add("Width(2-61):40nm");
        text_width.add("Width(2-61):41nm");
        text_width.add("Width(2-61):42nm");
        text_width.add("Width(2-61):43nm");
        text_width.add("Width(2-61):44nm");
        text_width.add("Width(2-61):45nm");
        text_width.add("Width(2-61):46nm");
        text_width.add("Width(2-61):47nm");
        text_width.add("Width(2-61):48nm");
        text_width.add("Width(2-61):49nm");
        text_width.add("Width(2-61):50nm");
        text_width.add("Width(2-61):51nm");
        text_width.add("Width(2-61):52nm");
        text_width.add("Width(2-61):53nm");
        text_width.add("Width(2-61):54nm");
        text_width.add("Width(2-61):55nm");
        text_width.add("Width(2-61):56nm");
        text_width.add("Width(2-61):57nm");
        text_width.add("Width(2-61):58nm");
        text_width.add("Width(2-61):59nm");
        text_width.add("Width(2-61):60nm");
        text_width.add("Width(2-61):61nm");

        tv_width1.setText("Width(2-61):6nm");
        tv_width2.setText("Width(2-61):6nm");
        tv_width3.setText("Width(2-61):6nm");
        tv_width4.setText("Width(2-61):6nm");
        tv_width5.setText("Width(2-61):6nm");
    }
    ...
    private void init_Text_Oversample()
    {
        tv_oversample1 = (TextView)findViewById(R.id.tv_oversample1);
        tv_oversample2 = (TextView)findViewById(R.id.tv_oversample2);
        tv_oversample3 = (TextView)findViewById(R.id.tv_oversample3);
        tv_oversample4 = (TextView)findViewById(R.id.tv_oversample4);
        tv_oversample5 = (TextView)findViewById(R.id.tv_oversample5);

        tv_oversample.add(tv_oversample1);
        tv_oversample.add(tv_oversample2);
        tv_oversample.add(tv_oversample3);
        tv_oversample.add(tv_oversample4);
        tv_oversample.add(tv_oversample5);

        img_tooltip1 = (ImageButton) findViewById(R.id.img_tooltip1);
        img_tooltip2 = (ImageButton)findViewById(R.id.img_tooltip2);
        img_tooltip3 = (ImageButton)findViewById(R.id.img_tooltip3);
        img_tooltip4 = (ImageButton)findViewById(R.id.img_tooltip4);
        img_tooltip5 = (ImageButton)findViewById(R.id.img_tooltip5);

        img_tooltip.add(img_tooltip1);
        img_tooltip.add(img_tooltip2);
        img_tooltip.add(img_tooltip3);
        img_tooltip.add(img_tooltip4);
        img_tooltip.add(img_tooltip5);

        img_tooltip.get(0).setOnClickListener(img_tooltip1_listenser);
        img_tooltip.get(1).setOnClickListener(img_tooltip2_listenser);
        img_tooltip.get(2).setOnClickListener(img_tooltip3_listenser);
        img_tooltip.get(3).setOnClickListener(img_tooltip4_listenser);
        img_tooltip.get(4).setOnClickListener(img_tooltip5_listenser);
    }
    ...
    private EditText.OnEditorActionListener section1_width = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                ...
                if(isExtendVer_PLUS)
                {
                    if(et_type.get(0).getText().toString().matches("")|| Integer.parseInt(et_width.get(0).getText().toString())>61 || Integer.parseInt(et_width.get(0).getText().toString())<2)
                    {
                        et_width.get(0).setText(Integer.toString(init_width[0]));
                        Dialog_Pane("Error","Scan width in pixels needs to be between '2' to '61'!");
                        return false; // consume.
                    }
                }
                else
    ...
    private EditText.OnEditorActionListener section2_width = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                ...
                if(isExtendVer_PLUS)
                {
                    if(et_type.get(1).getText().toString().matches("")|| Integer.parseInt(et_width.get(1).getText().toString())>61 || Integer.parseInt(et_width.get(1).getText().toString())<2)
                    {
    ...
    private EditText.OnEditorActionListener section3_width = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                ...
                if(isExtendVer_PLUS)
                {
                    if(et_type.get(2).getText().toString().matches("")|| Integer.parseInt(et_width.get(2).getText().toString())>61 || Integer.parseInt(et_width.get(2).getText().toString())<2)
                    {
    ...
    private EditText.OnEditorActionListener section4_width = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                ...
                if(isExtendVer_PLUS)
                {
                    if(et_type.get(3).getText().toString().matches("")|| Integer.parseInt(et_width.get(3).getText().toString())>61 || Integer.parseInt(et_width.get(3).getText().toString())<2)
                    {
    ...
    private EditText.OnEditorActionListener section5_width = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                ...
                if(isExtendVer_PLUS)
                {
                    if(et_type.get(4).getText().toString().matches("")|| Integer.parseInt(et_width.get(4).getText().toString())>61 || Integer.parseInt(et_width.get(4).getText().toString())<2)
                    {
    ...
    //region Oversampling tooltip
    private ImageButton.OnClickListener img_tooltip1_listenser = new Button.OnClickListener()
    {
        @Override
        public void onClick(View view) {
            Dialog_Pane("",ToolTip_Msg);
        }
    };
    private ImageButton.OnClickListener img_tooltip2_listenser = new Button.OnClickListener()
    {
        @Override
        public void onClick(View view) {
            Dialog_Pane("",ToolTip_Msg);
    ...
    private ImageButton.OnClickListener img_tooltip3_listenser = new Button.OnClickListener()
    {
        @Override
        public void onClick(View view) {
            Dialog_Pane("",ToolTip_Msg);
    ...
    private ImageButton.OnClickListener img_tooltip4_listenser = new Button.OnClickListener()
    {
        @Override
        public void onClick(View view) {
            Dialog_Pane("",ToolTip_Msg);
    ...
    private ImageButton.OnClickListener img_tooltip5_listenser = new Button.OnClickListener()
    {
        @Override
        public void onClick(View view) {
            Dialog_Pane("",ToolTip_Msg);
    ...
    private EditText.OnEditorActionListener section1_res = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_res.get(0).getText().toString().matches("")|| Integer.parseInt(et_res.get(0).getText().toString())< 3)
                {
                    et_res.get(0).setText(Integer.toString(init_res[0]));
                    Dialog_Pane("Error","D-Res. range should > 3!");
                    return false; // consume.
    ...
    private EditText.OnEditorActionListener section2_res = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_res.get(1).getText().toString().matches("")|| Integer.parseInt(et_res.get(1).getText().toString())< 3)
                {
                    et_res.get(0).setText(Integer.toString(init_res[1]));
                    Dialog_Pane("Error","D-Res. range should > 3!");
                    return false; // consume.
    ...
    private EditText.OnEditorActionListener section3_res = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_res.get(2).getText().toString().matches("")|| Integer.parseInt(et_res.get(2).getText().toString())< 3)
                {
    ...
    private EditText.OnEditorActionListener section4_res = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_res.get(3).getText().toString().matches("")|| Integer.parseInt(et_res.get(3).getText().toString())< 3)
                {
    ...
    private EditText.OnEditorActionListener section5_res = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_res.get(4).getText().toString().matches("")|| Integer.parseInt(et_res.get(4).getText().toString())< 3)
                {
    ...
    */
    ...
    private void CalOverSampling(int i)
    {
        ...
        int inputDigitalResolution = init_res[i];
        DecimalFormat df = new DecimalFormat("#.#");
        DecimalFormat df2 = new DecimalFormat("#");
        String Msg = "";
        if(isExtendVer_PLUS)
        {
            patWidth = (int)Math.ceil(Float.valueOf(widthnm_plus[init_width[i]]));
            baseOverSampleRate = (double)(Math.ceil((double)(init_end_nm[i] - init_start_nm[i]) / patWidth));
            overSampleRate = (double)inputDigitalResolution / Math.floor((double)(init_end_nm[i] - init_start_nm[i]) / Math.ceil(Float.valueOf(widthnm_plus[init_width[i]])));
        }
        else
        {
            patWidth = (int)Math.floor(Float.valueOf(widthnm[init_width[i]]));
            baseOverSampleRate = (double)(Math.floor((double)(init_end_nm[i] - init_start_nm[i]) / patWidth));
            overSampleRate = (double)inputDigitalResolution / Math.floor((double)(init_end_nm[i] - init_start_nm[i]) / Math.floor(Float.valueOf(widthnm[init_width[i]])));
        }
        if(inputDigitalResolution > MaxPattern)
        {
            init_res[i] = MaxPattern;
            et_res.get(i).setText(Integer.toString(MaxPattern));
            Msg = "D-Res exceeds maximum value!";
            inputDigitalResolution = init_res[i];
        ...
        if(res<0)
        {
            int shift  = Integer.parseInt(et_res.get(i).getText().toString()) + res;
            init_res[i] = shift;
            et_res.get(i).setText(Integer.toString(shift));
            Msg = "Total scan pattern num is over 624! \n Left pattern number is " +shift +".";
            inputDigitalResolution = init_res[i];
        ...
        if ((inputDigitalResolution > MaxPattern) || (inputDigitalResolution > Math.floor(baseOverSampleRate * 4.5)))
        {
            ...
            et_res.get(i).setText(Integer.toString((int)Math.floor(baseOverSampleRate * 4.5)));
            init_res[i] = (int)Math.floor(baseOverSampleRate * 4.5);
            CalOverSampling(i);
        }
        else
        {
            if(Double.isNaN(overSampleRate))
            {
                tv_oversample.get(i).setTextColor(Color.RED);
                img_tooltip.get(i).setVisibility(View.INVISIBLE);
                tv_oversample.get(i).setText("Oversampling : NaN");
            }
            else
            {
                overSampleRate = Double.parseDouble(df.format(overSampleRate));
                tv_oversample.get(i).setText("Oversampling : " + overSampleRate);
                if ((overSampleRate > 3 || overSampleRate < 2) && patWidth > 7)
                {
                    ...
                    tv_oversample.get(i).setTextColor(Color.RED);
                    img_tooltip.get(i).setVisibility(View.VISIBLE);
                ...
                {
                    tv_oversample.get(i).setTextColor(Color.BLUE);
                    img_tooltip.get(i).setVisibility(View.INVISIBLE);
                }
            }
        }
