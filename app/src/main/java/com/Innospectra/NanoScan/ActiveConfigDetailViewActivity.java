    ...
    public class ScanConfAdapter extends ArrayAdapter<ISCNIRScanSDK.ScanConfiguration> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                LinearLayout ll_scantype = (LinearLayout)convertView.findViewById(R.id.ll_scantype);
                LinearLayout ll_scanrepeats = (LinearLayout)convertView.findViewById(R.id.ll_scan_repeat);
                ...
                ll_scanrepeats.setVisibility(View.VISIBLE);
