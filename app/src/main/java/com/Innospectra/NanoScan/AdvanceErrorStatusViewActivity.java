...
public class AdvanceErrorStatusViewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] title1 = {"Timeout", "Power Down", "Power Up", "Standby", "Wake up", "Read Register", "Write Register", "Configure", "Set Buffer","Command","SET_PGA"};
        ...
        switch (pos) {
            ...
            case 11://System
                ...
                //Unstable Scan In Repeated times in errbyte[18]
                int data12 = errbyte[18]&0xFF;//avoid negative number
                int error_scan12 = 0x00000001;
                int ret = data12 & error_scan12;
                if (ret == error_scan12)
